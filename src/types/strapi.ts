...
/** Legacy Strapi v4 media relation wrapper (`media.data.attributes`). */
...
/** Media fields can be flattened (v5) or relation-wrapped (v4). */
export type StrapiMediaField = StrapiMedia | StrapiMediaRelation | null;
